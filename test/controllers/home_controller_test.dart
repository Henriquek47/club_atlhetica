...
void main() {
  ...
  test('get winner', ()async{
   ...
   when(client.get(Uri.parse(setUrlTeams(125, 71)), headers: headers)).thenAnswer((_) async => http.Response(last10RoundsOfTeam, 200));
   ...
   when(repository.getStatisticTeam(131, 121, 71)).thenAnswer((_) async => List<TeamStatistic>.generate(20, (index) => TeamStatistic(131, 121, 1, 1, statistic, statistic)));
