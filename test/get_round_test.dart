...
//
  ...
  // Round result = await repository.getRoundApi(0);
   ...
   expect(getRoundFunc.home, equals('America Mineiro'));
   expect(getRoundFunc.away, equals('Cuiaba'));
   expect(getRoundFunc.hour, equals('19:30'));
